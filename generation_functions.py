...
def generate_noise_1d(chunk: nd.chunk):
    return perlin.gen_perlin_noise_1D(chunk.generation_variables.size, chunk.seed, chunk.generation_variables.octaves, chunk.generation_variables.scaling_bias)

def generate_noise_2d(chunk: nd.chunk):
    return perlin.gen_perlin_noise_2D(chunk.generation_variables.size, chunk.seed, chunk.generation_variables.octaves, chunk.generation_variables.scaling_bias)

def generate_noise_2d_alt(chunk: nd.chunk):
    return perlin.gen_perlin_noise_2D_lines(chunk.generation_variables.size, chunk.seed, chunk.generation_variables.octaves, chunk.generation_variables.scaling_bias)
